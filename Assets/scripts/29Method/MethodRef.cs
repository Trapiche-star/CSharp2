...
namespace Method
{
    ...
    public class MethodRef : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //전투
            //MonsterrBattle(monster1, monster2);            
            //MonsterrBattle(monster2, monster1);
        ...
        //전투하는 함수, 공방식 : 체력 - = 공격력
        //매개변수로 공격하는 몬스터와 방어하는 몬스터를 입력받아 공방식을 적용
        void MonsterrBattle(Monster atkMonster, Monster defMonster)
        {
            //공방식
